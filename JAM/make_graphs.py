...
def dash_():
    ...
    day_req["Day"]=pd.to_datetime(day_req["Day"], format='%d/%m/%Y')
    ...
    fig1.update_layout(title_text='Clusters of maintenance requests')

    fig1.update_layout(font_family="Calibri",font_color="white")

    fig1.update_layout(template="plotly_dark")    

    fig1.write_html("templates/tmp/scatter_clustering.html")
    ...
    fig2.update_layout(font_family="Calibri",font_color="white")
    ...
    fig3.update_layout(font_family="Calibri",font_color="white")
    ...
    fig4.update_layout(font_family="Calibri",font_color="white")
    ...
    fig5.update_layout(font_family="Calibri",font_color="white")
    ...
    fig6.update_layout(font_family="Calibri",font_color="white")
    ...
    fig7.update_layout(font_family="Calibri",font_color="white")
